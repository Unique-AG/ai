...
class ClusterPlanPromptConfig(BaseModel):
    ...
    system_prompt: Annotated[
        ...
        description="The system prompt for one-shot fact clustering.",
    )
    user_prompt: Annotated[
        ...
        description="The user prompt for one-shot fact clustering.",
    )
