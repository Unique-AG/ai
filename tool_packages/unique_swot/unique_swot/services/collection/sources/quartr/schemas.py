...
class AudioDto(CamelizedModel):
    ...
    file_url: str | None = Field(
        default=None, examples=["https://quartr.com/file.mp3"]
    )
...
class PublicV3CompaniesGetParametersQuery(CamelizedModel):
    ...
    exchanges: str | None = Field(
        default=None, examples=["NasdaqCM,NasdaqGS,NYSE"]
    )
    ...
    direction: Direction | None = Field(
        default=Direction.ASC, examples=["asc"]
    )
    isins: str | None = Field(
        default=None, examples=["US0378331005,US0231351067"]
    )
    updated_before: str | None = Field(
        default=None, examples=["2024-01-24T12:00:00Z"]
    )
    updated_after: str | None = Field(
        default=None, examples=["2025-01-12T15:00:00Z"]
    )
...
class PublicV3EventsGetParametersQuery(CamelizedModel):
    ...
    end_date: str | None = Field(
        default=None, examples=["2025-01-10T13:00:00Z"]
    )
    start_date: str | None = Field(
        default=None, examples=["2024-12-12T15:00:00Z"]
    )
    isins: str | None = Field(
        default=None, examples=["US0378331005,US0231351067"]
    )
...
class PublicV3DocumentsReportsGetParametersQuery(
...
class PublicV3DocumentsReportsIdPagesGetResponse(
    PublicV3CompaniesGetResponse1
):
    pass


class PublicV3DocumentsReportsIdPagesGetResponse1(
    PublicV3CompaniesGetResponse2
):
    pass


class PublicV3DocumentsSlidesGetParametersQuery(
    PublicV3DocumentsGetParametersQuery
):
    pass
...
class PublicV3DocumentsSlidesIdPagesGetResponse1(
    PublicV3CompaniesGetResponse2
):
    pass
...
class PublicV3DocumentsTranscriptsIdGetResponse1(
    PublicV3CompaniesGetResponse2
):
    pass


class PublicV3DocumentsTranscriptsIdGetResponse2(
    PublicV3CompaniesIdGetResponse2
):
    pass


class PublicV3DocumentTypesGetParametersQuery(
    PublicV3EventTypesGetParametersQuery
):
    pass
...
class PublicV3LiveTranscriptsGetParametersQuery(
    PublicV3LiveGetParametersQuery
):
    pass
