...
## [3.5.1] - 2026-03-02
- Security: upgrade langgraph-checkpoint 3.0.1 → 4.0.1 (indirect dep)
- Security: upgrade google-cloud-aiplatform 1.128.0 → 1.139.0 (indirect dep)
- Security: upgrade nltk 3.9.2 → 3.9.3 (indirect dep, CVE)
- Security: upgrade langsmith 0.4.x → 0.7.9 (indirect dep)
- Security: upgrade cryptography 46.0.3 → 46.0.5 (indirect dep)
