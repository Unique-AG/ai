from _common.tools.internal_search.config import InternalSearchConfig
from _common.tools.uploaded_search.prompts import (
    DEFAULT_LANGUAGE_PARAM_DESCRIPTION,
    DEFAULT_SEARCH_STRING_PARAM_DESCRIPTION,
    DEFAULT_TOOL_DESCRIPTION_FOR_SYSTEM_PROMPT,
    DEFAULT_TOOL_FORMAT_INFORMATION_FOR_SYSTEM_PROMPT,
)
from _common.utils.validators import get_string_field_with_pattern_validation


class UploadedSearchConfig(InternalSearchConfig):
    param_description_search_string: str = (
