...
from unique_web_search.services.crawlers.url_safety import redirect as redirect_module

_REDIRECT_HTTPX = (
    "unique_web_search.services.crawlers.url_safety.redirect.httpx.AsyncClient"
)
