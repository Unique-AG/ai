...
def test_reduce_sources_with_model():
    chunks = [
        WebPageChunk(url="http://test.com", display_link="test.com", title="Test", snippet="s", content="Short content " * 10, order="1"),
        WebPageChunk(url="http://test2.com", display_link="test2.com", title="Test 2", snippet="s", content="Very long content " * 100, order="2"),
    ]
