...
## [1.11.5] - 2026-02-19
- Register `WebSearchConfig`, `WebSearchV1Config`, `WebSearchV2Config`, `QueryRefinementConfig`, `WebSearchToolParametersDescriptionConfig`, and `ContentProcessorConfig` with `@register_config()` for CI breaking-change detection
- Bump `unique-toolkit` minimum version to `1.46.10`
