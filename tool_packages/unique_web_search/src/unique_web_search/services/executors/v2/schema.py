"""V2 WebSearch tool parameters (research plan with steps)."""
...
from unique_web_search.services.executors.v2.prompts import STEP_QUERY_DESCRIPTION
...
class WebSearchPlan(BaseModel):
    ...
    def build_example_fsi(mode: SearchEngineMode) -> WebSearchPlan:
        """Build an FSI-themed example plan, adapted to *mode*.
