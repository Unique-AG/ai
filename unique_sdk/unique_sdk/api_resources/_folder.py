...
class Folder(APIResource["Folder"]):
    ...
    def move(
        ...
        **params,
        ...
        """
        Move a folder given its id or path and the new parent folder's id or path.
        """
        return cast(
            "Folder.FolderInfo",
            cls._static_request(
                "patch",
                f"{cls.RESOURCE_URL}/move",
                user_id,
                company_id=company_id,
                params=params,
            ),
    ...
    async def move_async(
        ...
        **params,
        ...
        """
        Async move a folder given its id or path and the new parent folder's id or path.
        """
        return cast(
            "Folder.FolderInfo",
            await cls._static_request_async(
