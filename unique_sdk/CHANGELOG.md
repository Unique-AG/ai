...
## [0.10.83] - 2026-03-10
- Add `ToolCall` API resource for node-chat `POST/GET /messages/tools` (batch create and list by messageId/messageIds). Enables toolkit and orchestrator to persist and load tool calls via a dedicated table.
