...
This module provides a wrapper system to integrate MCP (Model Context Protocol) tools
with the internal tool system, allowing MCP tools to behave like internal tools.
"""
...
class MCPToolWrapper(Tool[MCPToolConfig]):
    ...
    def get_tool_call_result_for_loop_history(
        ...
        if (
            hasattr(tool_response, "content_chunks")
            and tool_response.content_chunks
        ):
            content = str(tool_response.content_chunks)
