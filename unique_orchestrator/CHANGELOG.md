...
## [1.15.0] - 2026-03-10
- Add TODO system-reminder injection: `_inject_todo_reminder` appends task progress to the last user message when `TodoWriteTool` is enabled
- Add `_build_todo_memory_manager` to detect and wire TODO persistence from space tool config
