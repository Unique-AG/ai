...
class InvalidRequestError(UniqueErrorWithParamsCode):
    ...
    def from_pydantic_error(
        ...
        """Create InvalidRequestError from Pydantic ValidationError"""
        error_details = []
        params = {}
...
class RateLimitError(UniqueError):
    pass


class CardError(UniqueErrorWithParamsCode):
    def __init__(
        self,
        message,
        params,
