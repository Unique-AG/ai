...
terraform {
  ...
  #
  # backend "azurerm" {
  #   resource_group_name  = "rg-mcp-space-chat"              # Your resource group name
  #   storage_account_name = "stspacechatmcp<xxxxxx>"        # Get from: terraform output storage_account_name
