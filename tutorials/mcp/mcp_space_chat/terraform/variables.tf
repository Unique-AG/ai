...
variable "unique_frontend_base_url" {
  description = "UNIQUE_FRONTEND_BASE_URL — Unique web app origin for the chat embed iframe (e.g. https://next.qa.unique.app)"
  type        = string
}
