...
from domain import client_binding_rows, clients_from_rows  # noqa: E402
from mcp_dashboards.settings import AppSettings  # noqa: E402
from runtime import repo  # noqa: E402
...
def main() -> None:
    ...
    for table in TABLES:
        result = repo.list_client_rows(limit=100_000)
        fixtures[table] = client_binding_rows(clients_from_rows(result.rows))
