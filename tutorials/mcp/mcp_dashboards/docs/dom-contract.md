...
applied in each dataset's FastMCP domain mapping when building list / update responses (see
...
2. Implement the tool in `fastmcp/mcp_tools.py` against the regenerated models.
