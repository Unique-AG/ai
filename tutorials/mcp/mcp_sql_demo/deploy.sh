...
RG="rg-lab-demo-001-sql-mcp"
LOCATION="westeurope"
APP="sql-mcp-demo-app"
ACR="sqlmcpdemoregistry"
...
# Database: use in-memory SQLite (no external DB needed)
# Optional: add PM_POSITIONS_EMAIL=user@example.com to force all users to see that user's positions
...
echo ""
echo "IMPORTANT: Set secrets via Azure Portal or run:"
echo "  az webapp config appsettings set -n $APP -g $RG --settings UNIQUE_SDK_API_KEY=... UNIQUE_SDK_APP_ID=... ..."
