...
from ..models.brave_request_safesearch_type_0 import BraveRequestSafesearchType0
from ..models.brave_request_units_type_0 import BraveRequestUnitsType0
from ..types import UNSET, Unset

T = TypeVar("T", bound="BraveRequest")
...
class BraveRequest:
    ...
    Attributes:
        ...
        search_lang (None | str | Unset): Language code for result documents (Brave `search_lang`). `value` + `expose`
            behave like `country`.
        safesearch (BraveRequestSafesearchType0 | None | Unset): Adult content filter: `off`, `moderate` (API default),
            or `strict`. Usually set via admin `value`; enable `expose` only if the LLM may tune per query.
    ...
    safesearch: BraveRequestSafesearchType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.units, Unset):
            units = UNSET
        elif isinstance(self.units, BraveRequestUnitsType0):
        ...
        if isinstance(self.safesearch, Unset):
            safesearch = UNSET
        elif isinstance(self.safesearch, BraveRequestSafesearchType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_units(data: object) -> BraveRequestUnitsType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                units_type_0 = BraveRequestUnitsType0(data)

                return units_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BraveRequestUnitsType0 | None | Unset, data)
        ...
        def _parse_safesearch(
            data: object,
        ) -> BraveRequestSafesearchType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                safesearch_type_0 = BraveRequestSafesearchType0(data)

                return safesearch_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BraveRequestSafesearchType0 | None | Unset, data)
        ...
        brave_request.additional_properties = d
        return brave_request
