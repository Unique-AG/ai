...
from ...models.agent_search_response import AgentSearchResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = AgentSearchResponse.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        AgentSearchResponse | HTTPValidationError
    """
