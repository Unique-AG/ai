...
from unique_search_proxy_sdk._generated.models.basic_crawler_config import (
    BasicCrawlerConfig as SdkBasicCrawlerConfig,
)
from unique_search_proxy_sdk._generated.models.google_config import (
...
def to_sdk_google_config_request(
    request: GoogleSearchRequest,  # type: ignore[valid-type]
