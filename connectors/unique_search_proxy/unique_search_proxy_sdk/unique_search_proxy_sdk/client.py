...
from unique_search_proxy_sdk._generated.api.configuration import (
...
from unique_search_proxy_sdk._generated.models.crawl_request import CrawlRequest
...
from unique_search_proxy_sdk._generated.models.provider_default_config_response import (
    ProviderDefaultConfigResponse,
)
from unique_search_proxy_sdk._generated.models.provider_json_schema_response import (
    ProviderJsonSchemaResponse,
)
from unique_search_proxy_sdk._generated.models.providers_list_response import (
    ProvidersListResponse,
)
from unique_search_proxy_sdk._generated.models.search_call_schema_response import (
...
class UniqueSearchProxyClient:
    ...
    Wraps :class:`~unique_search_proxy_sdk._generated.client.Client` (from
    ``openapi-python-client``) with proxy-specific error mapping and helpers that
    accept application Pydantic config types.

    **SDK:** caller → proxy HTTP API. **Application:** ``unique_search_proxy_client.web``.
    """
