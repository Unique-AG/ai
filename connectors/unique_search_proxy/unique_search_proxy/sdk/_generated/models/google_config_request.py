...
from ..models.google_config_request_safe_search import GoogleConfigRequestSafeSearch
from ..models.google_config_request_site_search_filter_type_0 import (
    GoogleConfigRequestSiteSearchFilterType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GoogleConfigRequest")
...
class GoogleConfigRequest:
    ...
    Attributes:
        ...
        search_engine_id (None | str | Unset): Google Programmable Search Engine ID (`cx`). Defaults from
            `GOOGLE_SEARCH_ENGINE_ID` when deployed. Not sent as a query parameter (resolved at runtime). Default:
            '00c5f6e9ac4644f42'.
        safe (GoogleConfigRequestSafeSearch | Unset): SafeSearch level for every search: `active` (default) or `off`.
            Applied on all requests unless the call body overrides it. Default: GoogleConfigRequestSafeSearch.ACTIVE.
        ...
        site_search_filter (GoogleConfigRequestSiteSearchFilterType0 | None | Unset): With `siteSearch`: `i` = include
    ...
    search_engine_id: None | str | Unset = "00c5f6e9ac4644f42"
    safe: GoogleConfigRequestSafeSearch | Unset = GoogleConfigRequestSafeSearch.ACTIVE
    ...
    site_search_filter: GoogleConfigRequestSiteSearchFilterType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.site_search_filter, Unset):
            ...
            self.site_search_filter, GoogleConfigRequestSiteSearchFilterType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        safe: GoogleConfigRequestSafeSearch | Unset
        if isinstance(_safe, Unset):
            safe = UNSET
        else:
            safe = GoogleConfigRequestSafeSearch(_safe)
        ...
        def _parse_site_search_filter(
            data: object,
        ) -> GoogleConfigRequestSiteSearchFilterType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                site_search_filter_type_0 = GoogleConfigRequestSiteSearchFilterType0(
                    data
                )
                ...
                pass
            return cast(GoogleConfigRequestSiteSearchFilterType0 | None | Unset, data)
        ...
        google_config_request.additional_properties = d
        return google_config_request
