...
The low-level client is **generated** under :mod:`unique_search_proxy.sdk._generated`
...
from unique_search_proxy.sdk.client import UniqueSearchProxyClient
from unique_search_proxy.sdk.errors import UniqueSearchProxyClientError
