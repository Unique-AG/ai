...
from unique_search_proxy.web.core.errors import ValidationProxyError
...
def resolve_search_call_schema_from_config(
    ...
    *,
    ...
    from unique_search_proxy.web.core.registry import get_search_engine_descriptor
...
def _default_config(engine_id: str) -> SearchEngineConfigTypes:
    from unique_search_proxy.web.core.provider_config_schema import (
