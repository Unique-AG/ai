...
![Version: 2026.36.0](https://img.shields.io/badge/Version-2026.36.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2026.36.0](https://img.shields.io/badge/AppVersion-2026.36.0-informational?style=flat-square)
...
| httpClient.connection.proxyUsernameMetadataField | string | `"userName"` |  |
| httpClient.connection.proxyUsernameSource | string | `"settings"` |  |
| httpClient.tuning.httpClientCacheSize | int | `128` |  |
