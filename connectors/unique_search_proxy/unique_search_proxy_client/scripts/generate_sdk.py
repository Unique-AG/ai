#!/usr/bin/env python3
"""Export OpenAPI from the FastAPI app and regenerate ``unique_search_proxy_sdk._generated``."""
...
SDK_ROOT = ROOT.parent / "unique_search_proxy_sdk"
OUTPUT_PATH = SDK_ROOT / "unique_search_proxy_sdk" / "_generated"
