...
def test_is_docx_mime(filename, expected):
    assert is_docx_mime(Path(filename)) is expected
...
def test_is_pdf_mime(filename, expected):
    assert is_pdf_mime(Path(filename)) is expected
...
def test_is_xlsx_mime(filename, expected):
    assert is_xlsx_mime(Path(filename)) is expected
...
def test_is_pptx_mime(filename, expected):
    assert is_pptx_mime(Path(filename)) is expected
...
def test_is_json_mime(filename, expected):
    assert is_json_mime(Path(filename)) is expected
