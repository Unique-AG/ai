...
class TestContentIsIngested:
    def test__returns_default_undefined_value__when_applied_ingestion_config_is_none(
        self,
    ):
        """
        Purpose: Verify is_ingested returns the default undefined_value (True) when
    ...
    @pytest.mark.parametrize("undefined_value", [True, False])
    def test__returns_custom_undefined_value__when_applied_ingestion_config_is_none(
        self, undefined_value: bool
    ):
        """
        Purpose: Verify is_ingested honours a caller-supplied undefined_value when
                 applied_ingestion_config is None.
        ...
        Setup summary: Content with applied_ingestion_config=None; parametrise
                       undefined_value; assert the exact value is echoed back.
        """
        content = make_content(applied_ingestion_config=None)

        assert content.is_ingested(undefined_value=undefined_value) is undefined_value

    def test__returns_default_undefined_value__when_uniqueIngestionMode_key_missing(
        self,
    ):
        """
        Purpose: Verify is_ingested returns the default undefined_value (True) when
    ...
    @pytest.mark.parametrize("undefined_value", [True, False])
    def test__returns_custom_undefined_value__when_uniqueIngestionMode_key_missing(
        self, undefined_value: bool
    ):
        """
        Purpose: Verify is_ingested honours a caller-supplied undefined_value when the
        ...
        Setup summary: Config dict without uniqueIngestionMode; parametrise undefined_value;
    ...
    def test__undefined_value_arg_is_keyword_only(self):
        """
        Purpose: Verify that undefined_value cannot be passed as a positional argument.
