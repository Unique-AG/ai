...
class TestLanguageModelInfos:
    def test_can_list_all_defined_models(self):
        models = LanguageModelRegistry.list_models()
    ...
    def test_get_language_model(self):
        model = LanguageModelRegistry.get_model_info(LanguageModelName.AZURE_GPT_4_TURBO_1106)
    ...
    def test_get_custom_language_model(self):
        model = LanguageModelRegistry.get_model_info("My Custom Model")
    ...
    def test_get_language_model_raises_error_for_invalid_model(self):
        with pytest.raises(KeyError):
            LanguageModelRegistry.get_model_info("")
