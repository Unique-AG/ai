# ~/~ begin <<docs/plattforms/openai/openai.md#docs/.python_files/openai_simple_response.py>>[init]
...
# ~/~ end
# ~/~ begin <<docs/plattforms/openai/openai.md#openai_response_simple>>[init]
