# ~/~ begin <<docs/modules/examples/content/kb_service.md#./docs/.python_files/content_search_with_smart_rule_on_folders.py>>[init]
# ~/~ begin <<docs/modules/examples/content/kb_service.md#smart_rules_imports>>[init]
...
# ~/~ end
# ~/~ begin <<docs/modules/examples/content/kb_service.md#smart_rule_folder_content>>[init]
...
# ~/~ end
# ~/~ begin <<docs/modules/examples/content/kb_service.md#kb_service_combined_with_metadafilter>>[init]
