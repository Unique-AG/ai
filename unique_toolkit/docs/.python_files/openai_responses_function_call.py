# ~/~ begin <<docs/plattforms/openai/openai.md#docs/.python_files/openai_responses_function_call.py>>[init]
...
# ~/~ end
# ~/~ begin <<docs/plattforms/openai/openai.md#openai_responses_function_calling>>[init]
messages = (
    OpenAIMessageBuilder()
