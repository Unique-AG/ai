# ~/~ begin <<docs/plattforms/openai/openai.md#docs/.python_files/openai_responses_structured_output.py>>[init]
...
# ~/~ end
# ~/~ begin <<docs/plattforms/openai/openai.md#openai_responses_structured_output>>[init]
