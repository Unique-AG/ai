...
## [1.45.8] - 2026-02-02
- Add `get_full_history_with_contents_with_tools` for persisting the tool calls
- Hide the functionality behind a feature flag
- trim the unused sources from the tool calls
