...
# class ApiCall(BaseModel, Generic[PayloadType]):
...
class HumanVerificationManagerForEndpointCalling(
    Generic[
        PathParamsSpec,
        PathParamsType,
        PayloadParamSpec,
...
if __name__ == "__main__":
    ...
    human_verification_manager = HumanVerificationManagerForEndpointCalling(
