...
def init_sdk():
    ...
    unique_sdk.api_key = os.environ.get("API_KEY", "dummy")  # Optional if being run locally
    unique_sdk.app_id = os.environ.get("APP_ID", "dummy") # Optional if being run locally
