...
class LanguageModelInfo(BaseModel):
    ...
    def _construct_from_name(cls, model_name: LanguageModelName | str) -> Self:
        ...
        match model_name:
            ...
            case LanguageModelName.AZURE_GPT_55_2026_0424:
                return cls(
                    name=model_name,
                    provider=LanguageModelProvider.AZURE,
                    family=ModelFamily.OPENAI,
            ...
            case LanguageModelName.AZURE_GPT_55_PRO_2026_0424:
                return cls(
                    name=model_name,
                    provider=LanguageModelProvider.AZURE,
                    family=ModelFamily.OPENAI,
            ...
            case LanguageModelName.AZURE_GPT_6_ASTRA_2026_0903:
                return cls(
                    name=model_name,
                    provider=LanguageModelProvider.AZURE,
                    family=ModelFamily.OPENAI,
            ...
            case LanguageModelName.LITELLM_OPENAI_GPT_55:
                return cls(
                    name=model_name,
                    provider=LanguageModelProvider.LITELLM,
                    family=ModelFamily.OPENAI,
            ...
            case LanguageModelName.LITELLM_OPENAI_GPT_55_PRO:
                return cls(
                    name=model_name,
                    provider=LanguageModelProvider.LITELLM,
                    family=ModelFamily.OPENAI,
            ...
            case LanguageModelName.LITELLM_OPENAI_GPT_6_ASTRA:
                return cls(
                    name=model_name,
                    provider=LanguageModelProvider.LITELLM,
                    family=ModelFamily.OPENAI,
