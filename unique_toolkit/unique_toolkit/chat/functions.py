...
def pick_messages_in_reverse_for_token_window(
    ...
    token_count = count_tokens_for_model(messages[last_index].content or "", model_info)
    while token_count > limit:
        ...
        token_count = count_tokens_for_model(
            messages[last_index].content or "", model_info
        )
