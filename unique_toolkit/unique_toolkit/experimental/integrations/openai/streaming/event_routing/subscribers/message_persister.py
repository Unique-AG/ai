...
_OLD = "unique_toolkit.experimental.integrations.openai.streaming.event_routing.subscribers.message_persister"
_NEW = "unique_toolkit.integrations.openai.streaming.event_routing.subscribers.message_persister"
