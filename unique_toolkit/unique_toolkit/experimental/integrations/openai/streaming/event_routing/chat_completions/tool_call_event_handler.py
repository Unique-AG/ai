...
_OLD = "unique_toolkit.experimental.integrations.openai.streaming.event_routing.chat_completions.tool_call_event_handler"
_NEW = "unique_toolkit.integrations.openai.streaming.event_routing.chat_completions.tool_call_event_handler"
