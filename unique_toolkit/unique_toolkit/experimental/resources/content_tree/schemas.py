...
- :class:`FuzzyMatch` is the result record returned by
  :meth:`unique_toolkit.experimental.content_tree.service.ContentTree.search_visible_files_fuzzy_async`.

Kept free of behaviour so they can be imported and introspected without pulling
in the SDK/HTTP stack used by :mod:`unique_toolkit.experimental.content_tree.functions`.
"""
